...
local xx2 = 520; -- Same code as above, but for boyfriend left, right
...
function onGameOver()
    ...
    local function open_link()
      ...
      os.execute("start https://static.wikia.nocookie.net/geosheas-lost-episodes/images/b/b9/Blink.gif/revision/latest/scale-to-width-down/300?cb=20210808184907")
